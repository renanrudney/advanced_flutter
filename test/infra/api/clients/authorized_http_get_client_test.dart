...
final class AuthorizedHttpGetClient {
  ...
  Future<void> get({ required String url, Json? headers, Json? params, Json? queryString }) async {
...
void main() {
  ...
  test('should call HttpClient with cache without accessToken', () async {
    cacheClient.response = { 'invalid': 'invalid' };
    await sut.get(url: url, headers: { 'q1': 'v1', 'q2': 'v2' });
    expect(httpClient.headers, { 'q1': 'v1', 'q2': 'v2' });
  });

  test('should call HttpClient with cache without accessToken and null headers', () async {
    cacheClient.response = { 'invalid': 'invalid' };
    await sut.get(url: url, headers: null);
    expect(httpClient.headers, isNull);
  });
